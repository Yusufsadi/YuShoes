...
public class FXMLAdminController implements Initializable {
    ...
    @FXML
    private TableView<UserDetails> tabel;
    @FXML
    private TableColumn<UserDetails, String> columID;
    @FXML
    private TableColumn<UserDetails, String> columUsername;
    @FXML
    private TableColumn<UserDetails, String> columPassword;
    @FXML
    private TableColumn<UserDetails, String> columAlamat;
    @FXML
    ...
    private void loadDataFromDatabase(ActionEvent event) {
        try {
            ...
            while (rs.next()) {
                data.add(new UserDetails(rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(1)));
            }
    ...
    private void cari(ActionEvent event) {
         ...
         try {
            ...
            ResultSet rs = conn.createStatement().executeQuery("select * from pelanggan WHERE Username LIKE '"+pencari.getText()+"%'");
